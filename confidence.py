...
def dictdict(bdir):
    ...
    for xx in range(1, 201):
        with open(bdir + "/experiment_" + str(xx)) as f:
            a = f.readlines()
        ...
        ddict["experiment_" + str(xx)] = bdict
    return ddict
...
for x in metabolic:
    ...
    for i in range(1, 201):
        vals.append(exp1["experiment_" + str(i)][x])
    metadict[x] = (sorted(vals)[10], sorted(vals)[189])
